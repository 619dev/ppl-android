...
[![Version](https://img.shields.io/badge/Version-3.0.5-orange)](package.json)
...
- Decrypted message fields are removed before message-cache persistence, but the current 3.0.5 frontend does not encrypt the entire chat cache with Android Keystore.
